...
provider "azurerm" {
 subscription_id = "784cbafb-09da-42dc-b6df-26d5a39c34b2"
  client_id       = "dca82a94-b853-480a-b468-7f877e7addc6"
  client_secret   = "ZDY8Q~L6RxPsw.bjHuPnXXc~NvmMttYf0NPsjciN"
  tenant_id       = "24f213d4-aa1c-4f84-ad54-7f26dbd4545a"
  features {}
}
